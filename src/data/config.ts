...
export const config = {
    ...
    defaultNoImage : 'https://res.cloudinary.com/dqehxczmc/image/upload/f_webp/v1683624508/icons/dummy-post-horisontal-thegem-blog-default-large_i9rkvt_zdahwl.jpg',
    heroImages: {
    }
}
